    ...
    <Container data-testid={'load-safe-address-step'}>
      <Block margin="md">
        <Paragraph color="primary" noMargin size="lg">
          You are about to add an existing Velas Safe on <NetworkLabel />. First, choose a name and enter the Safe
          address. The name is only stored locally and will never be shared with Velas or any third parties.
        </Paragraph>
      ...
      <Block margin="sm">
        <Paragraph color="primary" noMargin size="lg">
          ...
          <StyledLink href="https://velas.com/pdf/terms_of_services.pdf" rel="noopener noreferrer" target="_blank">
            terms of use
          </StyledLink>
          {' and '}
          <StyledLink href="https://velas.com/pdf/website_privacy_notice.pdf" rel="noopener noreferrer" target="_blank">
            privacy policy
          </StyledLink>
          .
        </Paragraph>
