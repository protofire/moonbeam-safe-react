...
export const DEFAULT_CHAIN_ID =
  process.env.REACT_APP_DEFAULT_CHAIN_ID || (IS_PRODUCTION ? CHAIN_ID.RINKEBY : CHAIN_ID.RINKEBY)
...
export const GATEWAY_URL =
  ...
  (IS_PRODUCTION || isProdGateway() ? 'https://safe-client.gnosis.io' : 'https://safe-client.gnosis.io')
