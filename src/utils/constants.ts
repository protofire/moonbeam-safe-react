...
export const DEFAULT_CHAIN_ID =
  process.env.REACT_APP_DEFAULT_CHAIN_ID || (IS_PRODUCTION ? CHAIN_ID.VELAS_MAINNET : CHAIN_ID.VELAS_MAINNET)
...
export const WC_BRIDGE = process.env.REACT_APP_WC_BRIDGE || 'https://relay.walletconnect.org/'
